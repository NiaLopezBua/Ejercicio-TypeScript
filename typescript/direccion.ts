export class Direccion {
    ...
    private _piso: string | boolean;
    private _letra: string | boolean;
    private _codigoPostal: number;
    private _poblacion: string;
    private _provincia: string;

    constructor(calle: string, numero: number, piso: string | boolean, letra: string | boolean, codigoPostal: number, poblacion: string, provincia: string){
        this._calle = calle;
        this._numero = numero;
        this._piso = piso;
        this._letra = letra;
